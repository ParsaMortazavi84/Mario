...
struct infogame{
    ...
    int count1;
    int count2;
    struct result *gameResults1;// part 1
    struct result *gameResults2;// part 2 
};
...
int abilitygame1(FILE *fgame, SHORT X, SHORT Y, int result);
...
int abilitygame2(FILE *fgame, SHORT X, SHORT Y, int result);
